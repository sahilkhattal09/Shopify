      ...
      <ul className="mt-4 flex flex-col items-center">
        {sidebarItems.map((item, index) => (
          <li key={index} className="w-[96%] mt-2 mx-4">
            <Button
              className="text-white p-4 rounded-lg border border-white bg-softBlue transition-colors duration-300 hover:bg-AliceBlue hover:text-black active:bg-red-500 active:text-white w-full h-full"
              varient="none"
            >
              {item.name}
            </Button>
